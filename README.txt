...
OPTIONAL1. Use the optional1.txt and set up a daily Google Script (before midnight) to write keyword-timestamp pairs based on the day's tweets into another Google Spreadsheet