...
3.Enter your access information, possibly stating your Google's application specific password (to obtain from your Google account)
4.Enter your private/public spreadsheet key (from your spreadsheet url)
5.Enter your Twitter consumer key/secret, and access token key/secret
6.Finally you have to write the following headers into the first row of your spreadsheet.
